...
/** onlineOrNotInterface POST /api/interfaceInfo/onlineOrNot */
export async function onlineOrNotInterfaceUsingPost(
  body: API.IdRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/interfaceInfo/onlineOrNot', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
